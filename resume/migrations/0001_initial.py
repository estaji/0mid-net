    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "level",
                    models.CharField(max_length=20, verbose_name="Education Level"),
                ),
                (
                    "title",
                    models.CharField(max_length=50, verbose_name="Field of Study"),
                ),
                (
                    "description",
            ...
            options={
                "ordering": [
                    django.db.models.expressions.OrderBy(
                        django.db.models.expressions.F("end"),
                        descending=True,
                        nulls_first=True,
                    )
                ],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "logo",
                    models.ImageField(
                        upload_to="company_logos/", verbose_name="Company Logo"
                    ),
                ),
                (
                    "url",
                    models.URLField(
                        default="https://#", max_length=50, verbose_name="Company URL"
                    ),
                ),
                (
                    "company_details",
                    models.TextField(blank=True, verbose_name="Company Description"),
                ),
                ("start", models.DateField(verbose_name="Start Date")),
                (
                    "end",
                ...
                (
                    "location",
                    models.CharField(
                        blank=True, max_length=50, verbose_name="Location/Remote"
                    ),
                ),
                (
                    "summary",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "greeting",
                    models.CharField(max_length=50, verbose_name="Welcome Message"),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "instagram",
                    models.URLField(
                        blank=True, default="#", verbose_name="Instagram Account"
                    ),
                ),
                (
                    "twitter",
                    models.URLField(
                        blank=True, default="#", verbose_name="Twitter Account"
                    ),
                ),
            ],
        ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "title",
                    models.CharField(max_length=200, verbose_name="Technical Skill"),
                ),
                (
                    "certs",
                    models.CharField(
                        blank=True, max_length=100, verbose_name="Certification(s)"
                    ),
                ),
