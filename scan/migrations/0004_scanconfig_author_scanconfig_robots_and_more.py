...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.AddField(
            ...
            name='author',
            field=models.CharField(blank=True, max_length=160, verbose_name='Meta author tag'),
        ),
        migrations.AddField(
            model_name='scanconfig',
            name='robots',
            field=models.CharField(blank=True, max_length=160, verbose_name='Meta robots tag'),
        ),
        migrations.AddField(
            model_name='scanconfig',
            name='twitter_user',
