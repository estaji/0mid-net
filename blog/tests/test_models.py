...
class BlogConfigModelTests(TestCase):
    ...
    def test_add_configuration(self):
        ...
        self.assertEqual(item.blog_name, "My blog")
        self.assertEqual(item.blog_title, "My blog title")
        self.assertEqual(item.blog_subtitle, "this is my blog")
