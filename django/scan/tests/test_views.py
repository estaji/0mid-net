...
class HomeViewTest(TestCase):
    ...
    def test_valid_url_post_request(self):
        ...
        response = self.client.post(
            "/scan/", {"url": "www.google.com", "action": "ping"}
        )
    ...
    def test_valid_http_action_post_request(self):
        ...
        response = self.client.post(
            "/scan/", {"url": "www.google.com", "action": "http"}
        )

        self.assertEqual(response.status_code, 302)

    def test_valid_ssl_action_post_request(self):
        """Test a valid ssl action post request,"""
        """will redirects for home scan page"""

        response = self.client.post(
            "/scan/", {"url": "www.google.com", "action": "ssl"}
        )
    ...
    def test_invalid_action_post_request(self):
        ...
        response = self.client.post(
            "/scan/", {"url": "www.google.com", "action": "invalidX"}
        )
...
class ResultViewTest(TestCase):
    ...
    def test_view_url_accessible_by_name(self):
        """Test view url accessible by app:urlname"""
        response = self.client.get(reverse("scan:result", kwargs={"uuid": self.a_uuid}))
...
class FreshResultViewTest(TestCase):
    ...
    def test_view_url_accessible_by_name(self):
        """Test view url accessible by app:urlname"""
        response = self.client.get(
            reverse("scan:scan-fresh-result", kwargs={"uuid": self.running_uuid})
        )
    ...
    def test_view_returns_286_for_completed_job(self):
        ...
        response = self.client.get(
            reverse("scan:scan-fresh-result", kwargs={"uuid": self.finished_uuid})
        )
    ...
    def test_not_exist_uuid_result_returns_404(self):
        ...
        response = self.client.get("/scan/result/{}/freshresult".format(not_exist_uuid))
