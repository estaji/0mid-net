...
class Node(models.Model):
    ...
    TYPE_CHOICES = [("c", "Child"), ("p", "Parent")]

    node_type = models.CharField(
        max_length=1, choices=TYPE_CHOICES, verbose_name="Node Type"
    )
    location = models.CharField(max_length=20, blank=True, verbose_name="Location")
    url = models.URLField(
        max_length=50,
        default="https://#",
        unique=True,
    ...
    token = models.CharField(max_length=40, blank=True, verbose_name="Token")
...
class Job(models.Model):
    ...
    command = models.CharField(
        max_length=2, choices=COMMAND_CHOICES, verbose_name="Command type"
    )
    node = models.ForeignKey(Node, on_delete=models.CASCADE, verbose_name="Node")
    status = models.CharField(
        max_length=1, choices=STATUS_CHOICES, default="n", verbose_name="Status"
    )
